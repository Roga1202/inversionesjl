...
class updated_cliente_request extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'ci' =>'required | digits_between::1,8 | unique:cliente,CL_CI,'.request()->input('id').',CL_ID',
            'telefono' =>'required | digits_between::1,11 | unique:cliente,CL_telefono,'.request()->input('id').',CL_ID',
            'direccion' =>'required',
            'correo' =>'required | email | unique:cliente,CL_correo,'.request()->input('id').',CL_ID',
