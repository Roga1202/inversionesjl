...
class CreateTableProducto extends Migration
{
    ...
    public function up()
    {
        Schema::create('producto', function (Blueprint $table) {
            ...
            $table->timestamp('PR_inicio')->default(\DB::raw('CURRENT_TIMESTAMP'));
            $table->timestamp('PR_actualizacion')->default(\DB::raw('CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP'));
