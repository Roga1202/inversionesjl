...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <a class="btn btn-default btn-lg btn-block" href="/factura/crear">Nuevo comprobante</a>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <a href="/factura/detalle/{{$m->FA_ID}}">
                                {{ $m->cliente->CL_primer_nombre }} {{ $m->cliente->CL_primer_apellido }}
                            </a>
                        </td>
