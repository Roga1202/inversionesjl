...
@section('block')
    ...
    <form name="agregar_producto" class="form-horizontal" enctype="multipart/form-data" autocomplete="off" action="/producto/crear" method="post">
            ...
            <div class="input-group">
                     ...
                     <div class="input-group">                                                                    
                            <span class="input-group-addon"><i class="glyphicon glyphicon-folder-open"></i></span><select class="form-control @if($errors->has('categoria')) is-invalid @endif" id="categoria" name="categoria" >
